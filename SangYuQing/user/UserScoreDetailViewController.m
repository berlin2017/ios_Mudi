...
@interface UserScoreDetailViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [tableview registerNib:[UINib nibWithNibName:@"UserScoreLogTableViewCell" bundle:nil] forCellReuseIdentifier:@"score_detail_cell"];
}
